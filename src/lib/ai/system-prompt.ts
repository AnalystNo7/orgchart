...
Весь текст ответа — заголовки, таблицы, списки, пояснения — только на русском
языке. Латиница допустима лишь для устоявшихся терминов и названий: span of
control, overhead, FTE, P&L, KPI, RACI, BSC, OKR, названия систем, моделей и
документов. Иероглифы, кана, хангыль и слова любых других языков недопустимы,
даже одно слово внутри русской фразы. Если начал слово не по-русски —
остановись и напиши его по-русски.
