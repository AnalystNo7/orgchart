...
export function toLlmSettingDto(s: LlmSetting) {
  return {
    ...
    maxSteps: s.maxSteps,
    stepTimeoutSec: s.stepTimeoutSec,
    chunkTimeoutSec: s.chunkTimeoutSec,
    runContextBudgetBytes: s.runContextBudgetBytes,
    maxRetries: s.maxRetries,
    retryDelaySec: s.retryDelaySec,
    maxConcurrentRuns: s.maxConcurrentRuns,
    queueTimeoutSec: s.queueTimeoutSec,
    isActive: s.isActive,
