...
export default function AdminLlmPage() {
  ...
  // The admin gate lives in the settings layout; here we only wait for the
  // session so the fetch carries auth cookies of a settled session.
  useEffect(() => {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold">Подключения к модели</h2>
