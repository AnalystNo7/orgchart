...
Для ответа нужна AI-модель: нажмите **«Отправить в AI»** или выберите готовый запрос под этим сообщением. Чтобы все вопросы шли в модель сразу, включите тумблер **AI** у поля ввода.`;
